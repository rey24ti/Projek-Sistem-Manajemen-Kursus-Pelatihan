      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Daftar untuk membuat akun baru di sistem manajemen kursus.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register" autocomplete="off">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Masukkan nama lengkap" name="name" id="name" aria-label="Name" aria-describedby="name" value="<?php echo e(old('name')); ?>" autocomplete="off" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                  <input type="email" class="form-control" placeholder="Masukkan email Anda" name="email" id="email" aria-label="Email" aria-describedby="email-addon" value="<?php echo e(old('email')); ?>" autocomplete="off" required>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    <p class="text-danger text-xs mt-2">Harap setujui Syarat dan Ketentuan terlebih dahulu.</p>
                  <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <p class="text-sm mt-3 mb-0">Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="text-dark font-weight-bolder">Masuk</a></p>
              </form>
            </div>
          </div>
        </div>
...
<?php echo $__env->make('layouts.user_type.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\rey_vinsen_bpf\laragon-6.0-minimal\www\Projek-Sistem-Manajemen-Kursus-Pelatihan\resources\views/session/register.blade.php ENDPATH**/ ?>