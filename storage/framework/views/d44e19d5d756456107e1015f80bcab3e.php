        ...
        <div class="table-responsive p-0">
          <table class="table align-items-center mb-0">
            ...
            <tbody>
              ...
              <?php /** @var \App\Models\Enrollment $enrollment */ ?>
              <tr>
                <td>
                ...
                <td class="align-middle text-center">
                  <div class="progress-wrapper w-75 mx-auto">
                    ...
                    <div class="progress">
                      <div class="progress-bar bg-gradient-info" style="width: <?php echo e($enrollment->progress ?? 0); ?>%;"></div>
                    </div>
                  </div>
                </td>
                ...
                <td class="align-middle text-center text-sm">
                  <div class="d-flex flex-column align-items-center">
                    ...
                    <div class="mt-2 d-flex gap-1">
                      ...
                      <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#rejectModal<?php echo e($enrollment->id); ?>">Reject</button>
                      <?php endif; ?>
...
<div class="modal fade" id="rejectModal<?php echo e($enrollment->id); ?>" tabindex="-1" aria-labelledby="rejectModalLabel<?php echo e($enrollment->id); ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="rejectModalLabel<?php echo e($enrollment->id); ?>">Tolak Pembayaran</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="<?php echo e(route('enrollments.reject-payment', $enrollment)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="modal-body">
          <div class="alert alert-warning" role="alert">
            <strong>Perhatian!</strong> Anda akan menolak pembayaran untuk pendaftaran ini.
          </div>
          <div class="mb-3">
            <label class="form-label">Alasan Penolakan <span class="text-danger">*</span></label>
            <textarea name="notes" class="form-control" rows="3" required placeholder="Masukkan alasan penolakan..."></textarea>
          </div>
          <p class="text-sm text-muted"><strong>Peserta:</strong> <?php echo e($enrollment->user->name); ?></p>
          <p class="text-sm text-muted"><strong>Kursus:</strong> <?php echo e($enrollment->course->title); ?></p>
          <p class="text-sm text-muted"><strong>Harga:</strong> Rp <?php echo e(number_format($enrollment->course->price, 0, ',', '.')); ?></p>
        </div>
        <div class="modal-footer">
