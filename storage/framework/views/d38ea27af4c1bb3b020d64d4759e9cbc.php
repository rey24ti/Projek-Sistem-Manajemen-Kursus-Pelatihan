<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse px-0 w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?php echo e(url('tables')); ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?php echo e(url('billing')); ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?php echo e(url('virtual-reality')); ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="<?php echo e(url('rtl')); ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?php echo e(url('sign-in')); ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?php echo e(url('sign-up')); ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
...
<?php /**PATH D:\BPF_PIDOO\laragon-6.0-minimal\www\Projek-Sistem-Manajemen-Kursus-Pelatihan1\resources\views/layouts/navbars/auth/sidebar-rtl.blade.php ENDPATH**/ ?>