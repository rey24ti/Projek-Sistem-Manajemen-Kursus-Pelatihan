                ...
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      ...
                      <h5 class="font-weight-bolder mb-0"><?php echo e($stats['active_courses']); ?></h5>
                    </div>
                  </div>
                  <div class="col-4 text-end">
                ...
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      ...
                      <h5 class="font-weight-bolder mb-0"><?php echo e($stats['completed_courses']); ?></h5>
                    </div>
                  </div>
                  <div class="col-4 text-end">
...
<?php echo $__env->make('layouts.user_type.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\BPF_PIDOO\laragon-6.0-minimal\www\Projek-Sistem-Manajemen-Kursus-Pelatihan\resources\views/staff/reports/index.blade.php ENDPATH**/ ?>