              ...
              <tr>
                ...
                <td class="align-middle">
                  <form action="<?php echo e(route('enrollments.update', $enrollment)); ?>" method="POST" class="d-inline">
                    ...
                    <input type="number" name="progress" class="form-control form-control-sm d-inline-block mt-1" style="width: 80px;" value="<?php echo e($enrollment->progress); ?>" min="0" max="100" placeholder="Progress %">
                  </form>
                </td>
              </tr>
