            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="{{ auth()->user()->profile_photo_path ? Storage::url(auth()->user()->profile_photo_path) : asset('assets/img/bruce-mars.jpg') }}" alt="profile_photo" class="w-100 border-radius-lg shadow-sm">
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('profile_photo')border border-danger rounded-3 @enderror">
